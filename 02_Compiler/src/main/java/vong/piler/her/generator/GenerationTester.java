...
public class GenerationTester {
	...
	private static void addTester(List<ValueModel> values) {
		...
		writer.addMultiCommand(GeneratorMethods.generateCalclations(OperationEnum.ADD, values));
		writer.addPrt();
		writer.eof();
	}
	...
	private static void subTester(List<ValueModel> values) {
		...
		writer.addMultiCommand(GeneratorMethods.generateCalclations(OperationEnum.SUB, values));
		writer.addPrt();
		writer.eof();
	}
	...
	private static void mulTester(List<ValueModel> values) {
		...
		writer.addMultiCommand(GeneratorMethods.generateCalclations(OperationEnum.MUL, values));
		writer.addPrt();
		writer.eof();
	}
	...
	private static void divTester(List<ValueModel> values) {
		...
		writer.addMultiCommand(GeneratorMethods.generateCalclations(OperationEnum.DIV, values));
		writer.addPrt();
		writer.eof();
	}
	...
	private static void modTester(List<ValueModel> values) {
		...
		writer.addMultiCommand(GeneratorMethods.generateCalclations(OperationEnum.MOD, values));
		writer.addPrt();
		writer.eof();
	}
	...
	private static void lesTester(List<ValueModel> values) {
		...
		writer.addMultiCommand(GeneratorMethods.generateCalclations(OperationEnum.LES, values));
		writer.addPrt();
		writer.eof();
	}
	...
	private static void gtrTester(List<ValueModel> values) {
		...
		writer.addMultiCommand(GeneratorMethods.generateCalclations(OperationEnum.GTR, values));
		writer.addPrt();
		writer.eof();
	}
	...
	private static void eqiTester(List<ValueModel> values) {
		...
		writer.addMultiCommand(GeneratorMethods.generateCalclations(OperationEnum.EQI, values));
		writer.addPrt();
		writer.eof();
	}
	...
	private static void nqiTester(List<ValueModel> values) {
		...
		writer.addMultiCommand(GeneratorMethods.generateCalclations(OperationEnum.NQI, values));
		writer.addPrt();
		writer.eof();
	}
}
